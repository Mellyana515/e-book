...
<<<<<<< HEAD
        ...
        @if (session('info'))
          <div style="margin-bottom:16px;padding:12px 14px;border-radius:12px;background:#eff6ff;border:1px solid #bfdbfe;color:#1d4ed8;font-size:13px;line-height:1.6;">
            {{ session('info') }}
          </div>
        @endif
